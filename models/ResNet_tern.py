...
from .ternarized_modules import get_centroid, get_quantized
...
def resnet18b_ff_lf_tex1(num_classes=1000, input_grain_size = (1,1), input_num_bits = 4, input_M2D = 0.0, res_grain_size = (1,1), res_num_bits = 4, res_M2D = 0.0, output_grain_size = (1,1), output_num_bits = 4, output_M2D = 0.0, save_path = './'):
    global ti
    ti = 0
    global num_res
    num_res = 20
...
def resnet18b_fq_lq_tex1(num_classes=1000, input_grain_size = (1,1), input_num_bits = 4, input_M2D = 0.0, res_grain_size = (1,1), res_num_bits = 4, res_M2D = 0.0, output_grain_size = (1,1), output_num_bits = 4, output_M2D = 0.0, save_path = './'):
    global ti
    ti = 0
    global num_res
    num_res = 20
...
def resnet34b_ff_lf_tex1(num_classes=1000, input_grain_size = (1,1), input_num_bits = 4, input_M2D = 0.0, res_grain_size = (1,1), res_num_bits = 4, res_M2D = 0.0, output_grain_size = (1,1), output_num_bits = 4, output_M2D = 0.0, save_path = './'):
    global ti
    ti = 0
    global num_res
    num_res = 36
...
def resnet34b_fq_lq_tex1(num_classes=1000, input_grain_size = (1,1), input_num_bits = 4, input_M2D = 0.0, res_grain_size = (1,1), res_num_bits = 4, res_M2D = 0.0, output_grain_size = (1,1), output_num_bits = 4, output_M2D = 0.0, save_path = './'):
    global ti
    ti = 0
    global num_res
    num_res = 36
...
def resnet50b_ff_lf_tex1(num_classes=1000, input_grain_size = (1,1), input_num_bits = 4, input_M2D = 0.0, res_grain_size = (1,1), res_num_bits = 4, res_M2D = 0.0, output_grain_size = (1,1), output_num_bits = 4, output_M2D = 0.0, save_path = './'):
    global ti
    ti = 0
    global num_res
    num_res = 52
...
def resnet50b_fq_lq_tex1(num_classes=1000, input_grain_size = (1,1), input_num_bits = 4, input_M2D = 0.0, res_grain_size = (1,1), res_num_bits = 4, res_M2D = 0.0, output_grain_size = (1,1), output_num_bits = 4, output_M2D = 0.0, save_path = './'):
    global ti
    ti = 0
    global num_res
    num_res = 52
...
def resnet101b_ff_lf_tex1(num_classes=1000, input_grain_size = (1,1), input_num_bits = 4, input_M2D = 0.0, res_grain_size = (1,1), res_num_bits = 4, res_M2D = 0.0, output_grain_size = (1,1), output_num_bits = 4, output_M2D = 0.0, save_path = './'):
    global ti
    ti = 0
    global num_res
    num_res = 103
...
def resnet101b_fq_lq_tex1(num_classes=1000, input_grain_size = (1,1), input_num_bits = 4, input_M2D = 0.0, res_grain_size = (1,1), res_num_bits = 4, res_M2D = 0.0, output_grain_size = (1,1), output_num_bits = 4, output_M2D = 0.0, save_path = './'):
    global ti
    ti = 0
    global num_res
    num_res = 103
